...
public class MenusAggRoot implements AggregateRoot, Serializable {
     ...
     * 菜单列表、功能列表 子集
     */
    private List<MenusAggRoot> list;
     ...
     * @return
     */
    public void setButtonCode(List<MenusAggRoot> list) {
     ...
     * @return
     */
    public void addMenusTree(List<MenusAggRoot> list) {
